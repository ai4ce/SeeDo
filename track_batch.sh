...
output_folder="/home/bw2716/VLMTutor/media/output_demo/wooden_block/"

# 遍历 long_demo1.mp4 到 long_demo30.mp4
for i in {1..7}; do
  input_video="${input_folder}three_wooden${i}.mp4"
  output_video="${output_folder}three_wooden${i}_sam2_contour.mp4"
