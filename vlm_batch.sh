...
# 定义路径
VALLEYS_FILE="/home/bw2716/VLMTutor/new_wooden_block_selected_valleys.csv"
CSV_FILE="/home/bw2716/VLMTutor/new_wooden_block_bbx.csv"
VIDEO_DIR="/home/bw2716/VLMTutor/media/output_demo/new_wooden_block"
...
do
  ...
  # 调用 Python 脚本处理每个视频
  python VLM_CaP/vlm.py --input "$video_path" --list "$indexlist_python" --demo "$demo" --bbx_csv "$CSV_FILE"
